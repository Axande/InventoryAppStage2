package com.example.andrei.inventoryappstage2;
...
import com.example.andrei.inventoryappstage2.data.ProductContract.ProductEntry;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNumberOfProducts = findViewById(R.id.product_quantity);
        mProductPrice = findViewById(R.id.product_price);
        mNameOfSupplier = findViewById(R.id.supplier_name);
        mPhoneOfSupplier = findViewById(R.id.supplier_phone_number);
        mOrderButton = findViewById(R.id.order_btn);
        mAddButton = findViewById(R.id.product_quantity_add);
        mSubtractButton = findViewById(R.id.product_quantity_substract);
        mDeleteProductButton = findViewById(R.id.action_delete);
